...
public class App {
	...
	private static String ORIGINAL_IMAGE = "/tmp/charImageCreator/hello.png"; // Need to point where file is located with a full path
	private static String IMAGE_SAVE_LOCATION = "/tmp/charImageCreator/"; // This is the directory where generated images are going to be stored
	...
	public static void main(String[] args) {
		...
		if (args.length < 2) {
			System.out.println("Usage:\njava -jar <executable-name>.jar <image-path> <output-images-path>\n");
			System.out.println("example:\njava -jar CharImageCreator-0.0.1-SNAPSHOT.jar /tmp/hello.png /tmp/images (these path will work only in Linux)");
			System.exit(1);
			return;
		}
